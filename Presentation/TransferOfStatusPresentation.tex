...
\begin{frame}{How to measure $\gamma$?}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \begin{fmffile}{fgraph/fgraph_BtoDK1}
        ...
        \begin{fmfgraph*}(6,6)
          ...
          \fmflabel{$\bar{u}$}{i1}
          \fmflabel{$b$}{i2}
          \fmfv{l.d=20,l.a=180,l={$B^-$\mylbrace{30}{-12}}}{B}
          \fmflabel{$\bar{u}$}{o1}
          \fmflabel{$c$}{o2}
          \fmflabel{$\bar{u}$}{o3}
          \fmflabel{$s$}{o4}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \begin{fmffile}{fgraph/fgraph_BtoDK2}
        ...
        \begin{fmfgraph*}(6,6)
          ...
          \fmflabel{$\bar{u}$}{i1}
          \fmflabel{$b$}{i2}
          \fmfv{l.d=20,l.a=180,l={$B^-$\mylbrace{90}{0}}}{B}
          \fmflabel{$\bar{u}$}{o1}
          \fmflabel{$s$}{o2}
          \fmflabel{$\bar{c}$}{o3}
          \fmflabel{$u$}{o4}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item{Interference when $D^0$ and $\bar{D^0}$ decay into a common final state}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \begin{fmffile}{fgraph/fgraph_BtoDK1Small}
        ...
        \begin{fmfgraph*}(5,4)
          ...
          \fmflabel{$s$}{o4}
          \fmfv{l.d=15,l.a=0,l={\myrbrace{30}{-12}}$D^0$}{D}
          \fmfv{l.d=15,l.a=0,l={\myrbrace{30}{10}}$K^-$}{K}
          \fmf{fermion}{o1,i1}
          \fmf{fermion,tension=1.5}{i2,v1}
          \fmf{fermion}{v1,o2}
          \fmf{phantom,tension=1.5}{t9,v2}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \begin{fmffile}{fgraph/fgraph_BtoDK2Small}
        ...
        \begin{fmfgraph*}(5,4)
          ...
          \fmflabel{$\bar{u}$}{i1}
          \fmflabel{$b$}{i2}
          \fmfv{l.d=20,l.a=180,l={$B^-$\mylbrace{70}{0}}}{B}
          \fmflabel{$\bar{u}$}{o1}
          \fmflabel{$s$}{o2}
          \fmflabel{$\bar{c}$}{o3}
          \fmflabel{$u$}{o4}
